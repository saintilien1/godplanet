					...
					<div class="row d-flex justify-content-center">
						...
						<div class="col-lg-10 contact-right"> 
                            <div role="group" class="btn-group"> 
                                 <button class="btn btn-default" type="button"><a href="../user/addUser.php">Add User</a></button>
                             </div> 
                            <div role="group" class="btn-group"> 
                                 <button class="btn btn-default" type="button"><a href="../user/user.php">Manage User</a></button>
                            </div> 
                            <div class="row">
                                 <div class="container">
                                 ...
                                 <?php 
                                                 ...
                                                 try{    
                                                     ...
                                                     $_SESSION["id"]=$id;
                                                     $stmt = $pdo->query("SELECT * FROM user_tb WHERE id=".$id);  
				            ...
				            <form class="booking-form"  action="../../../data/update/updateU.php" method="post">
								 	<div class="row">  
                                        <div class="col-lg-12 d-flex flex-column">
                                            <label>Nom</label>
											<input name="nom" placeholder="nom" value="<?php echo $nom ?>" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Title'"   class="form-control mt-20" required="" type="text"> 
										</div>  
                                        <div class="col-lg-12 d-flex flex-column">
                                            <label>Prenom</label>
											<input name="prenom" placeholder="prenom" value="<?php echo $prenom ?>" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Title'"   class="form-control mt-20" required="" type="text"> 
										</div>  
                                        <div class="col-lg-12 d-flex flex-column">
                                            <label>Email</label>
											<input name="email" placeholder="email" value="<?php echo $email ?>" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Title'"   class="form-control mt-20" required="" type="email"> 
										</div>  
										<div class="col-lg-12 d-flex flex-column"> 
                                            <label>Role</label> 
                                        ...
                                        <div class="col-lg-12 d-flex flex-column"> 
                                            <label>Password</label>
											 <input name="password" placeholder="password" value="<?php echo $password ?>" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Title'"   class="form-control mt-20" required=""  type="password"> 
										</div>  
