                                 ...
                                 <div class="container">
								 	...
								 	<div class="row">  
                                        <div class="col-lg-12 d-flex flex-column">
                                            ...
                                            $title="";
                                            try{
                                                 $stmt = $pdo->query("SELECT * FROM image_tb"); 
                                                   echo "<table><tr><th>ID</th><th>Title</th><th>Description</th><th colspan=\"3\">Action</th>";
                                                        ...
                                                        $description = $row["description"];
                                                            ...
                                                            if(strlen($description) > 30 ){ 
                                                             ...
                                                             echo "<tr><td>".$id."
                                                                 <td>".$title."</td>
                                                                 <td>".$description."</td> 
                                                                 <td><a href=\"updateImage.php?id=".$row['id']."\" class=\"edit\">edit</a></td>
                                                                 <td><a href=\"../../../data/delete/deleteImage.php?id=".$row['id']."\"  class=\"delete\">delete</a></td>
