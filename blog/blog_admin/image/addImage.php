				...
				<div class="container"> 
					<div class="row d-flex justify-content-center">
						...
						<div class="col-lg-10 contact-right"> 
				            ...
				            <form class="booking-form"  action="../../../data/InsertI.php" enctype="multipart/form-data" method="post">
								 	<div class="row">  
                                         <div class="col-lg-12 d-flex flex-column">
                                            <label for="title">Title</label>
											<input name="title"  onfocus="this.placeholder = ''" id="title" onblur="this.placeholder = 'Title'"   class="form-control mt-20" required="" type="text"> 
										</div> 
                                        <div class="col-lg-12 d-flex flex-column">
