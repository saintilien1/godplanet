					...
					<div class="row d-flex justify-content-center">
						...
						<div class="col-lg-10 contact-right">
                             ...
                             <div role="group" class="btn-group"> 
                                 <button class="btn btn-default"  type="button"><a href="post/post.php">Add Post</a></button>
                             </div>
                                        ...
                                        <div class="col-lg-12 d-flex flex-column">
                                            ...
                                            try{
                                                 $stmt = $pdo->query("SELECT * FROM post_tb"); 
                                                   echo "<table><tr><th>ID</th><th>Title</th><th>Autor</th><th colspan=\"3\">Action</th>";
                                                     while ($row = $stmt->fetch()) { 
                                                         ...
                                                         $title= $row["title"];
                                                                ...
                                                                echo "<tr><td>" . $row["id"]. "</td><td>".
                                                                    $title.
                                                                          "</td><td>".$row["autor"]."</td><td><a href=\"post/updatePost.php?id=".$row['id']."\" class=\"edit\">edit</a></td><td><a href=\"../../data/delete/deletePost.php?id=".$row['id']."\"  class=\"delete\">delete</a></td><td><a href=\"post/publish.php?id=".$row['id']."\" class=\"publish\">publish</a></td></tr>";
                                                            }
                                                             echo "</table>";
