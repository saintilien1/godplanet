				...
				<div class="container">
					...
					<div class="row d-flex justify-content-center">
						...
						<div class="col-lg-10 contact-right"> 
				            ...
				            <form class="booking-form"  action="../../../data/InsertB.php" method="post">
								 	<div class="row">  
                                        <div class="col-lg-12 d-flex flex-column">
                                            <label for="tile">Title</label>
											<input name="sujet" id="title" placeholder="title" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Title'"   class="form-control mt-20" required="" type="text"> 
										</div>   
										<div class="col-lg-12 d-flex flex-column"> 
                                            <label for="message">Body</label>
											<textarea class="form-control mt-20" id="message" name="message" placeholder="Body" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Messege'" required=""></textarea>
                                        ...
                                        <div class="col-lg-12 d-flex flex-column"> 
                                            <label for="autor">Autor</label>
											 <input name="autor" id="autor"   onfocus="this.placeholder = ''" onblur="this.placeholder = 'Title'" value="<?php echo $nom.' '.$prenom; ?>"   class="form-control mt-20" required=""  type="text" readonly> 
										</div>  
										<div class="col-lg-12 d-flex  justify-content-end send-btn" >
											<input class="btn btn-default primary-btn mt-20 text-uppercase lnr lnr-arrow-right" value="Add Post" type="submit">
										</div>  
									</div>
					  		</form>             
							 </div> 
